...
@Component({
    ...
    imports: [HeaderComponent, SearchBarComponent, CommonModule, ProductComponent, FormsModule, PreviewComponent, MessageDialogComponent, RegisterProductComponent, UpdateProductComponent]
})
